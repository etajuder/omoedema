                ...
                <div class="col-sm-12">
                    ...
                    <div class="breadcrumbs">
                        <ul>
                            ...
                            <li><a href="#" title="Search"><?=  get("q")?></a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="" style="margin: 10px;">
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <?=App::message("error", "No result found")?>
                <?php endif; ?>
        ...
        <?php if($pagin_value >= 1):?>
                ...
                <div class="col-sm-12">
                    <ul class="pagination">
                         <?php if($page > 1 ):?>
                        <li>
                            <a href="<?=  App::route("search?q=".  get("q")."&"."page=").($page -1)?>" class="prev">
                        ...
                        <li class="<?php if($page == $i):?>active <?php endif;?>"> <a href="<?=  App::route(url_title("search")."?q=".  get("q")."&"."page=").$i?>"><?=$i?></a></li>
                        <?php endfor;?>
                        <?php if($pagin_value > $page):?>
                        <li>
                            <a href="<?=  App::route(url_title("search")."?q=".  get("q")."&"."page=").($page+ 1)?>" class="next"> <i class="pe-7s-angle-right"></i></a>
                        </li>
                        <?php endif;?>
                    </ul>
                </div>
