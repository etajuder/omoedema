        ...
        <?php if($pagin_value >= 1):?>
                ...
                <div class="col-sm-12">
                    <ul class="pagination">
                         <?php if($page > 1 ):?>
                        <li>
                            <a href="<?=  App::route(url_title("downloads")."?page=").($page -1)?>" class="prev">
                        ...
                        <li class="<?php if($page == $i):?>active <?php endif;?>"> <a href="<?=  App::route(url_title("downloads")."?page=").$i?>"><?=$i?></a></li>
                        <?php endfor;?>
                        <?php if($pagin_value > $page):?>
                        <li>
                            <a href="<?=  App::route(url_title("downloads")."?page=").($page+ 1)?>" class="next"> <i class="pe-7s-angle-right"></i></a>
                        </li>
                        <?php endif;?>
                    </ul>
                </div>
