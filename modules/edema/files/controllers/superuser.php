...
class superuser extends Base {
    ...
    public function __construct() {
        ...
        if($this->data["is_logged_in"]){
            ...
            $this->data["site"]["admins"] = $this->superuser->get_admins();
             ...
             $this->data["site"]["ads"] = $this->ads->get_all_ads();
        }
    }
    ...
    public function settings(){
      ...
      public function ads(){
        ...
        $this->data["form"]["message"] = "";
        if(post("type") != null){
            $this->data["form"]["message"] = $this->ads->add_ads();
        }
            $this->data["page"]["name"] = "Manage Ads";
        $this->template->inject_view("admin-ads",  $this->data);
